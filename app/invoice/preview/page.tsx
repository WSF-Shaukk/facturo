...
export default function PreviewPage() {
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      // Ensure we preserve the invoice number format
      setInvoiceData({
        ...parsedData,
        invoiceNumber: parsedData.invoiceNumber, // Keep the original invoice number format
      });
    }
    setIsLoading(false);
  }, []);
  ...
  const shareViaWhatsApp = () => {
    ...
    const message = encodeURIComponent(
      `Invoice ${invoiceData.invoiceNumber} for ${invoiceData.clientName}`
    );
  ...
  return (
    <div className="container mx-auto px-4 py-8" dir={dir}>
      <div className="max-w-3xl mx-auto">
        ...
        <div
          className="mb-6 bg-white p-6 border rounded-lg shadow-sm"
          ref={pdfRef}
        >
