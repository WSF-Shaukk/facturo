    ...
    <div className="p-5 bg-[#18191A] shadow-lg max-w-4xl mx-auto text-white font-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-8  pb-6 mb-1">
        ...
        <div className="space-y-2 text-sm">
          <div className="text-lg font-bold mb-1">{data.businessName}</div>
          ...
          <tbody>
            {data.lineItems.map((item, idx) => (
              <tr key={idx} className="border-b border-gray-800">
                <td className="py-2 truncate whitespace-nowrap overflow-hidden max-w-[10px]">{item.description}</td>
      ...
      <div className="mb-8 space-y-2 mt-14 text-[14px]">
        ...
        <div className="flex items-center gap-2 ">
          <span className="inline-block size-5 "><svg viewBox="0 0 24 24" fill="#6a8aec" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path fillRule="evenodd" clipRule="evenodd" d="M3.4 4h17.2A2.4 2.4 0 0 1 23 6.4v11.2a2.4 2.4 0 0 1-2.4 2.4H3.4A2.4 2.4 0 0 1 1 17.6V6.4A2.4 2.4 0 0 1 3.4 4ZM22 8H2v3h20V8Zm-6 6a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1Z" fill="#6a8aec"></path></g></svg></span>
